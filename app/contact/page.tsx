    ...
    <main>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-[#5356ff] mb-6 leading-tight">
            Let&apos;s Build Something That Scales
          </h1>
          <p className="text-slate-600 text-lg mb-4 max-w-2xl mx-auto font-medium">
          ...
          <div className="border border-indigo-100 p-8 lg:p-12 shadow-2xl bg-white rounded-[2rem]">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-3">
                <label className="block text-sm font-semibold text-slate-700 mb-2">You Are A:</label>
                <div className="grid grid-cols-2 gap-4">
                  {["Creator", "Agency", "Brand / Business", "Other"].map((role) => (
                    <label key={role} className="flex items-center space-x-2 text-sm text-slate-600">
                      <input
                        type="radio"
                        name="role"
                        value={role}
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="mt-16 text-center text-slate-500 text-sm max-w-2xl mx-auto leading-relaxed">
